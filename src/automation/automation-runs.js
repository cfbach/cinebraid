...
const { SimpleZipWriter } = require("../server/zip-stream");
const { summarizeRecordedCost } = require("../generation/generation-cost");
const ProductionAuthority = require("../../public/shared-production-authority");
const Lifecycle = require("../generation/generation-lifecycle");
...
const PaidPermit = require("../generation/paid-dispatch-permit");
