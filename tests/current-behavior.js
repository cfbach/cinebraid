...
async function main() {
  ...
  assert.deepStrictEqual(tests, [
    ...
    "audio-recording-real-browser.py",
    "audio-recording.js",
    ...
    "automation-project-binding-real-browser.py",
    ...
    "ci-census-contracts.js",
    "ci-census-negative-controls.js",
    ...
    "no-project-shell-truth-real-browser.py",
    "no-project-shell-truth.js",
    "ofp-contract.js",
    ...
    "project-refresh-race-real-browser.py",
    "project-refresh-single-owner.js",
    ...
    "reference-demand.js",
    "reference-enrollment.js",
    "reference-first-canon-negative-controls.js",
    "reference-first-canon-real-browser.py",
    "reference-first-canon.js",
