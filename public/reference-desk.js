...
(function() {
  ...
  function pickerTargetWords(p){
    ...
    p.entityName=entity?.name||p.id;p.stateName=state?(state.name||state.id):'';p.slotLabel=slot?(slot.label||slot.id):'';
