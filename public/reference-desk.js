...
(function() {
  ...
  document.addEventListener('click',event=>{
    ...
    const t=event.target.closest('[data-rd-action],[data-rd-results-slot],[data-rd-candidate],[data-rd-slot],[data-rd-asset],#rd-add-candidate,#rd-picker-retry,#rd-picker-refresh');if(!t)return;
